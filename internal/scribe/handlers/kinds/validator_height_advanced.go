...
//go:embed validator_height_advanced.md
var validatorHeightAdvancedDoc string
...
func (h *Height) Meta() handlers.Meta {
...
func (h *Height) Handle(_ context.Context, o normalizer.Observation) []types.Op {
	...
	payload := sk.ValidatorHeightAdvanced{From: prev, To: height}
...
func init() {
	handlers.Register("validator.height_advanced",
		func(cluster string) handlers.Handler { return NewHeight(cluster) },
		validatorHeightAdvancedDoc)
}
